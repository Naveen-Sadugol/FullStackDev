...
public class ExcelAssignment7 {
    ...
    public static void readContents(){
        int r=0;
        try{
            fin=new FileInputStream("E:\\Vijay Kumar A\\ExcelSheets\\ReadContents\\vegetables.xlsx");
    ...
    public static void writeContent(String data,int r){
        try{
            ...
            fout=new FileOutputStream("E:\\Vijay Kumar A\\ExcelSheets\\Excel7.xlsx");
            wb1.write(fout);
        }catch (Exception e){
            e.printStackTrace();
        }
